...
![BitDownToc](https://github.com/apotitech/bitdowntoc/raw/main/src/jsMain/resources/og-bitdowntoc.png)
...
<p align="center">
  <b>
  Try it out now!<br>
  ✨✨ <a href="https://apotitech.github.io/bitdowntoc/">https://apotitech.github.io/bitdowntoc/</a> ✨✨
  </b>
</p>
...
<!-- TOC start (generated with https://github.com/apotitech/bitdowntoc) -->

- [BitDownToc](#bitdowntoc)
  - [Usage](#usage)
    - [Online](#online)
...
Go to https://apotitech.github.io/bitdowntoc !

### From the command line

The **JVM jar** can be found in the [releases](https://github.com/apotitech/bitdowntoc/releases).
If you want the latest version, check the [nightly release](https://github.com/apotitech/bitdowntoc/releases/nightly).
